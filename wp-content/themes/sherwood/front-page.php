...
<article id="content" class="content content-home" role="content">
	...
	<section class="hero section dark">
		...
		<div class="container container-md">
			...
			<a href="<?php echo site_url('/contact'); ?>" class="btn">Book Your Event</a>
		</div>
	</section>
		...
		<div class="container">
			<figure class="media-content">
				...
				<figcaption>
					...
					<a href="<?php echo site_url('/accommodations'); ?>" class="btn">View Gallery</a>
				</figcaption>
			</figure class="media-content">
		</div>
	</section>
	<section class="section dark">
		...
		<div class="container container-md">
			...
			<a href="<?php echo site_url('/contact'); ?>" class="btn">Request More Info</a>
		</div>
	</section>
	<section class="section">
		<div class="container">
			<figure class="media-content">
				<figcaption>
					...
					<a href="<?php echo site_url('/accommodations'); ?>" class="btn">See Our Accomodations</a>
				</figcaption>
				<img src="https://02f0a56ef46d93f03c90-22ac5f107621879d5667e0d7ed595bdb.ssl.cf2.rackcdn.com/sites/1632/photos/730141/fall_wedding_2017_21220171109-32253-lscsgf_x435.JPG" alt="Behind House" />
			</figure class="media-content">
		</div>
